  ...
  return (
    <div className="ttr-profile">
      <div className="border border-bottom-0">
        ...
        <div className="p-2">
          ...
          <ul className="mt-4 nav nav-pills nav-fill">
            ...
            <li className="nav-item">
              <Link to="/profile/user_likes"
                className={`nav-link ${location.pathname.indexOf('user_likes') >= 0 ? 'active' : ''}`}>
                Likes</Link>
            </li>

            <li className="nav-item">
              <Link to="/profile/user_dislikes"
                className={`nav-link ${location.pathname.indexOf('user_dislikes') >= 0 ? 'active' : ''}`}>
                Dislikes</Link>
            </li>
      ...
      <Routes>
        ...
        <Route path="/user_likes" element={<MyLikes />} />
        <Route path="/user_dislikes" element={<MyDislikes />} />
      </Routes>
    </div>
  );
}
